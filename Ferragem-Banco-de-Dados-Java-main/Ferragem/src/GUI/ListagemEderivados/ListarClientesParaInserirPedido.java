...
import GUI.Insercao.InserirPedido;
...
public class ListarClientesParaInserirPedido extends javax.swing.JFrame {

private ArrayList<Clientes> listaClientes;
  public ListarClientesParaInserirPedido() {
    initComponents();
    carregarClientes(); 
}
...
private void preencherTabela(ArrayList<Clientes> lista) {
    ...
    private void initComponents() {
        ...
        InserirPedido = new javax.swing.JButton();
        ...
        InserirPedido.setText("Inserir Pedido");
    ...
    if (row != -1) {
        ...
        InserirPedido tela = new InserirPedido(idCliente);
        tela.setLocationRelativeTo(this); 
        tela.setVisible(true);
    } else {
        javax.swing.JOptionPane.showMessageDialog(this, 
            "Selecione um cliente na tabela para inserir pedido.");
    }
    ...
    private javax.swing.JButton InserirPedido;
