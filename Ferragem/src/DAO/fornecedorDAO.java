...
public class fornecedorDAO {
    ...
    public ArrayList<Fones_forn> listarFones(int idFornecedor) throws SQLException {
    ArrayList<Fones_forn> lista = new ArrayList<>();
    String sql = "SELECT f.ID_fornecedor, f.DDD, f.numero, fr.fornecedor " +
                 "FROM fones_forn f " +
                 "JOIN fornecedor fr ON f.ID_fornecedor = fr.ID_Forn " +
