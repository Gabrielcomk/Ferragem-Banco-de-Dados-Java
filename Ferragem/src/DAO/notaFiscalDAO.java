...
public class notaFiscalDAO {
   ...
   public ArrayList<Nota_fiscal> listarTodos() throws SQLException {
    ...
    String sql = "SELECT nf.NF, nf.data, nf.ID_entrega, nf.ID_cliente, " +
                 "       c.nome AS nomeCliente, e.nome AS nomeEntregador " +
                 "FROM nota_fiscal nf " +
                 "JOIN clientes c ON nf.ID_cliente = c.ID_Cliente " +
                 "JOIN entregador e ON nf.ID_entrega = e.ID_entregador";
