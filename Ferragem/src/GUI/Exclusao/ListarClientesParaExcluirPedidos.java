...
public class ListarClientesParaExcluirPedidos extends javax.swing.JFrame {

private ArrayList<Clientes> listaClientes;
  public ListarClientesParaExcluirPedidos() {
    initComponents();
    carregarClientes(); 
}
...
private void preencherTabela(ArrayList<Clientes> lista) {
    ...
    if (row != -1) {
        ...
        new ListarPedidoParaExcluir(idCliente).setVisible(true);
    } else {
        javax.swing.JOptionPane.showMessageDialog(this,
