...
public class AlteraEstoque extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AlteraEstoque.class.getName());
    ...
    try {
        ...
        Logger.getLogger(AlteraEstoque.class.getName()).log(Level.SEVERE, null, ex);
