...
for (Classes.Fornecedor f : lista) {
    ...
    private void initComponents() {
        ...
        ListarFones = new javax.swing.JButton();
        ...
        ListarFones.setText("Listar Fones");
        ListarFones.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ListarFonesActionPerformed(evt);
            }
        });
    ...
    private void ListarFonesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ListarFonesActionPerformed
    ...
    new ListarFonesFornecedor(idFornecedor).setVisible(true);

    }//GEN-LAST:event_ListarFonesActionPerformed

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton ListarFones;
