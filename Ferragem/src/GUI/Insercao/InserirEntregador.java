...
public class InserirEntregador extends javax.swing.JFrame {

    
    public InserirEntregador() {
        initComponents();
    }
    ...
    String contato = Contato.getText().trim();
    ...
    try {
        Classes.Entregador e = new Classes.Entregador(0, nome, contato); 
        DAO.EntregadorDAO dao = new DAO.EntregadorDAO();
        dao.inserir(e);

        javax.swing.JOptionPane.showMessageDialog(this,
            "Entregador inserido com sucesso!");

        Nome.setText("");
        Contato.setText("");
    } catch (Exception ex) {
        javax.swing.JOptionPane.showMessageDialog(this,
            "Erro ao inserir entregador: " + ex.getMessage());
    }
