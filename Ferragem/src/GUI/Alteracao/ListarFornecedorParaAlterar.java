...
import GUI.Alteracao.MudarFornecedor;
import java.util.ArrayList;
import javax.swing.table.DefaultTableModel;


public class ListarFornecedorParaAlterar extends javax.swing.JFrame {

private int idCliente;

      public ListarFornecedorParaAlterar() {
    initComponents();
...
for (Classes.Fornecedor f : lista) {
 ...
 int linha = tabelaFornecedor.getSelectedRow();
    if (linha >= 0) {
        ...
        MudarFornecedor tela = new MudarFornecedor(id);
        tela.setVisible(true);
        dispose();
    } else {
        javax.swing.JOptionPane.showMessageDialog(this, "Selecione um fornecedor para alterar.");
    }        
