...
public class ListarEstoqueParaAlterar extends javax.swing.JFrame {

private int idCliente;

      public ListarEstoqueParaAlterar() {
    initComponents();
    ...
    if (linha >= 0) {
        Classes.Estoque e = new Classes.Estoque(
            (int) tabelaEstoque.getValueAt(linha, 0),
            (String) tabelaEstoque.getValueAt(linha, 1),
            (String) tabelaEstoque.getValueAt(linha, 2),
            Float.parseFloat(tabelaEstoque.getValueAt(linha, 3).toString()),
            (int) tabelaEstoque.getValueAt(linha, 4)
        );

        GUI.Alteracao.MudarEstoque tela = new GUI.Alteracao.MudarEstoque();
        tela.setDados(e);
        tela.setVisible(true);
        dispose();
    } else {
        javax.swing.JOptionPane.showMessageDialog(this, "Selecione um item para alterar.");
    }
